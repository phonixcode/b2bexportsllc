                        ...
                        <ul class="navbar-nav header-right">
							<li class="nav-item dropdown notification_dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
												<div class="timeline-panel">
                                                    <div class="media me-2 media-danger">
														{{ ucfirst(mb_substr($item->name, 0, 2, 'utf-8')) }}
													</div>
													<div class="media-body">
														<h6 class="mb-1">{{ $item->name }} Send you Message</h6>
														<small class="d-block">{{ Carbon\Carbon::parse($item->created_at)->isoFormat('MMMM Do YYYY, hh:mm:ssa') }}</small>
													</div>
												</div>
											</li>
                                            @endforeach
                                    ...
                                    <a class="all-notification" href="{{ route('notifications.index') }}">See all notifications <i class="ti-arrow-end"></i></a>
                                </div>
                                @endif
                            </li>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="" href="{{ route('notifications.index') }}" aria-expanded="false">
						<i class="fas fa-info-circle"></i>
